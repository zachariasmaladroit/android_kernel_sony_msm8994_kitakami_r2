 ...
 * (default: 0.6ms * (1 + ilog(ncpus)), units: nanoseconds)
 *
 ...
 * [10.000.000 in effect = multiplicator x1.6~; base = 6.000.000]
 */
 ...
 * (default: 0.075 msec * (1 + ilog(ncpus)), units: nanoseconds)
 * [multiplicator x3]
 */
 ...
 * [multiplicator x2 ; 1/6 of sched_latency]
 */
