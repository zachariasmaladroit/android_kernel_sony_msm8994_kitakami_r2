 ...
 */
unsigned int sysctl_sched_wakeup_granularity = 7500000UL;
unsigned int normalized_sysctl_sched_wakeup_granularity = 7500000UL;
...
unsigned int __read_mostly sysctl_sched_init_task_load_pct = 55;
...
unsigned int __read_mostly sched_heavy_task = 85;
#endif
