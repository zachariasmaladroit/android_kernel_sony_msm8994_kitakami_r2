...
static inline void mmc_host_clk_init(struct mmc_host *host)
{
	...
	host->clk_delay = 8;
	/*
	 * Default clock gating delay is 550ms to account for
	 * broken UHS microSDXC card handling.
	 * Accepting higher power consumption in the process.
	 * This value can be tuned by writing into sysfs entry.
	 */
	host->clkgate_delay = 550;
